              ...
              <div class="col-12">
                  ...
                  <main class="row">
                      <div class="col-lg-4 col-md-6 col-sm-8 mx-auto bg-white py-3 mb-4">
                          <div class="row">
                              <div class="col-12">
                                <form @submit.prevent="handleLogin">                                    <div class="mb-3">
                                          <label for="email" class="form-label">Email</label>
                                          <input type="email" id="username" v-model="user.email"  class="form-control" required>
                                      </div>
                                      <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                          <button type="submit" class="btn btn-outline-dark"  @click="handleLogin" >Login</button>
                                      </div>
                                  </form>
                              </div>
                          </div>
