                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <ul class="top-nav">
                                        ...
                                        <li>
                                            <a href="/bienvenue"><i class="fas fa-sign-in-alt me-2"></i>Login</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 py-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- Product -->
                                        <div class="col-lg-3 col-sm-6 my-3" v-for="prod in produit" :key="prod.id">
                                            <div class="col-12 bg-white text-center h-100 product-item">
                                                <div class="row h-100">
                                                    <div class="col-12 p-0 mb-3">
                                                        <a href="product.html">
                                                            <img :src="prod.gallerie" class="img-fluid">
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="col-12 mb-3 align-self-end">
                                                        <button class="btn btn-outline-dark" type="button" @click="addarticletopanier(prod.id)" ><i class="fas fa-cart-plus me-2"></i>Add to cart</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
await
axios.post("http://localhost:8000/api/Cart/",{product_id: productId}, {
            headers: {
